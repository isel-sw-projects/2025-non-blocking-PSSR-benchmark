\section{Web Framework Architectures and Approaches to PSSR}
...
In the example shown in Listing \ref{lst:streaming-response-body}, HTML content is written and flushed in discrete chunks,
