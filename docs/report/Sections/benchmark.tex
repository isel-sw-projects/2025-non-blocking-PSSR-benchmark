...
frameworks. It also includes a set of tests to ensure the correctness of the
implementations and to validate the HTML output. 

\section{Data Model}

The benchmark includes two different data models, defined as \texttt{Presentation} and \texttt{Stock}, as
