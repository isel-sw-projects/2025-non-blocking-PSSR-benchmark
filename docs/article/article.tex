...
\Title{Enabling Progressive Server-Side Rendering for Legacy Web Template Engines with Java Virtual Threads}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Enabling Progressive Server-Side Rendering for Legacy Template Engines with Java Virtual Threads}
