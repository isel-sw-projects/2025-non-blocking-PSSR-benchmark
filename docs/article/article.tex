...
\begin{adjustwidth}{-\extralength}{0cm}
	...
	\isAPAandChicago{}{%
		\begin{thebibliography}{999}
			\bibitem[Spring WebFlux Comparing Template Engines(2025)]{spring-webflux-comparing-template-engines}
			Spring WebFlux Comparing Template Engines. 2025. \textit{GitHub}. Available online: \url{https://github.com/xmlet/spring-webflux-comparing-template-engines}.
			\bibitem[Model-View-Controller Pattern(2009)]{Bucanek2009}
			James Bucanek. 2009. Model-View-Controller Pattern. In \textit{Learn Objective-C for Java Developers}; Apress: Berkeley, CA, USA; pp. 353-402.
			\bibitem[StreamingResponseBody - Spring Framework 6.2.6 API(2025)]{Spring-StreamingResponseBody}
			Spring Framework. 2025. StreamingResponseBody - Spring Framework 6.2.6 API. Available online: \url{https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/web/servlet/mvc/method/annotation/StreamingResponseBody.html}.
		\end{thebibliography}
	}{}
