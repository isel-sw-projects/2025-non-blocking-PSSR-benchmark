...
concurrency. These findings contrasts with prior research, such as Beronić et
al.~\cite{9803765}, which reported lower heap usage for Kotlin coroutines
(52--99~MB) compared to Java Virtual Threads (16--64~MB), albeit under
different workloads.
