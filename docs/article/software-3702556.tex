...
Sussman, G.; Steele, G.  
\newblock {\em Scheme: An Interpreter for Extended Lambda Calculus};  
...
\newblock {\em RESTful Java with JAX-RS 2.0: Designing and Developing
  Distributed Web Services}; O'Reilly Media, Inc.: Sebastopol, CA, USA, 2013.
...
Maurer, N.; Wolfthal, M.
\newblock {\em Netty in Action}; Manning Publications: Shelter Island, NY, USA, 2015.
