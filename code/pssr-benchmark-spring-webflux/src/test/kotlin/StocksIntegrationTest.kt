...
internal class StocksIntegrationTest {
    ...
    fun htmlTemplates(): Stream<Arguments> {
        return Stream.of(
            ...
            Arguments.of(
                Named.of(
                    "Rocker Sync",
                    RouteAndExpected("/stocks/rocker/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "JStachio Sync",
                    RouteAndExpected("/stocks/jstachio/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Pebble Sync",
                    RouteAndExpected("/stocks/pebble/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Freemarker Sync",
                    RouteAndExpected("/stocks/freemarker/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Trimou Sync",
                    RouteAndExpected("/stocks/trimou/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Velocity Sync",
                    RouteAndExpected("/stocks/velocity/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Thymeleaf Sync",
                    RouteAndExpected("/stocks/thymeleaf/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "HtmlFlow Sync",
                    RouteAndExpected("/stocks/htmlFlow/sync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "KotlinX Sync",
                    RouteAndExpected("/stocks/kotlinx/sync", wellFormedHtmlAssertion().replace("<!DOCTYPE html>", "")),
                ),
            ),
            ...
            Arguments.of(
                Named.of(
                    ...
                    RouteAndExpected("/stocks/rocker/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "JStachio Virtual Thread",
                    RouteAndExpected("/stocks/jstachio/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Pebble Virtual Thread",
                    RouteAndExpected("/stocks/pebble/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Freemarker Virtual Thread",
                    RouteAndExpected("/stocks/freemarker/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Trimou Virtual Thread",
                    RouteAndExpected("/stocks/trimou/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Velocity Virtual Thread",
                    RouteAndExpected("/stocks/velocity/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "Thymeleaf Virtual Thread",
                    RouteAndExpected("/stocks/thymeleaf/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "HtmlFlow Virtual Thread",
                    RouteAndExpected("/stocks/htmlFlow/virtualSync", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "KotlinX Virtual Thread",
                    RouteAndExpected("/stocks/kotlinx/virtualSync", wellFormedHtmlAssertion().replace("<!DOCTYPE html>", "")),
                ),
            ),
            ...
            Arguments.of(
                Named.of(
                    ...
                    RouteAndExpected("/stocks/htmlFlow/suspending", wellFormedHtmlAssertion()),
                ),
            ),
            Arguments.of(
                Named.of(
                    "KotlinX Functional Router",
                    RouteAndExpected("/stocks/kotlinx", kotlinXMalformedAssertion()),
                ),
            ),
        )
    }
